...
const searchInput2 = document.getElementById("search-space");
// const countryName2 = getCountryByState(searchInput2.value);
searchInput1.addEventListener("input", e =>{
  const value = e.target.value 
  console.log(value);
  const countrynamefromstate = getCountryByState(value).toLowerCase();
  newArray = array.filter((array)=>
  {
...
button1.addEventListener("click", jobfunction());
